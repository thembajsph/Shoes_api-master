...
/* SELECT * FROM products_table JOIN brands_table ON brands_table.id = products_table.id JOIN size_table ON brands_table.id = size_table.id JOIN colour_table ON brands_table.id = colour_table.id; */